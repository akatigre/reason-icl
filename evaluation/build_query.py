...
Thus, the answer is D (tokyo), \\boxed{tokyo}.
""",
"code": """
...
def create_one_query(problem, examples, shot_num, shot_type, use_caption, use_ocr):
   ...
   # ocr
    ...
    # prompt
    if shot_type == 'solution':
        prompt = "Output your answer inside \\boxed{}.\n\n"
    else:
        assert shot_type == 'code'
        prompt = "Output the code inside ```python \n YOUR CODE HERE \n```.\n\n"
